...
const Feedback = () => {
  return (
    <div className="bg-white rounded-lg shadow-md  w-[350px] h-[370px]">
      ...
      <div className="px-6">
        <div className="flex justify-between items-end">
          <h4 className="font-semibold text-normal mt-4">Lindsey Weiss</h4>
          <span className="text-xs text-gray-400">Just Now</span>
        </div>
        <h2 className="text-2xl font-bold mb-4">Appreciation</h2>
        <p className="text-gray-800 text-[12.5px] mt-3 font-semibold">
          Hi there,
          <br />
          Thank you for the feedback you provided. We appreciate your thoughts
          and suggestions. Your feedback is valuable to us and helps us improve
          our services.
          <br />
          <br />
          Best regards,
